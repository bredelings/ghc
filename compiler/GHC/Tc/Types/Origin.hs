...
data CtOrigin
  ...
  | OccurrenceOf OccName           -- Occurrence of an overloaded identifier
...
exprCtOrigin (HsVar _ (L _ name)) = OccurrenceOf (getOccName name)
exprCtOrigin (HsUnboundVar _ uv)  = OccurrenceOf uv
